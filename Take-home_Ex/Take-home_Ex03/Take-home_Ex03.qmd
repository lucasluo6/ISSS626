...
These two models command the highest resale prices, with DBSS flats typically selling around 900,000 SGD, and Type S1 flats reaching around 1.2 million SGD. This reflects the premium nature and potential desirability of these models. Model A and Premium Apartment Models:

Model A and Premium Apartment flats generally show a higher median resale price compared to other models (excluding DBSS and Type S1). Model A has a wider range in resale prices, indicating variability within this model type. Standard, New Generation, and Simplified Models:

These models generally have lower resale prices, with medians around 400,000-500,000 SGD. They exhibit less variation, suggesting consistent valuation for these standard models. Improved and Model A2 Models:
